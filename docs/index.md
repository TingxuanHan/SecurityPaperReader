...
### [OTTER: A Red-Teaming System for Toxicity-Evading Jailbreak Prompt Optimization](https://arxiv.org/abs/2606.21077v1)
...
### [Local LLM Agents as Vulnerable Runtimes:A Source-Code Audit of the Agent Runtime Layer](https://arxiv.org/abs/2606.21071v1)
...
**来源**：arxiv · AI安全 · **发布日期**：2026-06-18 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.20508v1)

**摘要总结**：Prior work has shown that in-context demonstrations can jailbreak language models, but it remains unclear how models interpret different types of compliance demonstrations.
...
**来源**：arxiv · AI安全 · **发布日期**：2026-06-18 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.20470v1)

**摘要总结**：Agentic AI systems increasingly rely on language-model components to interpret instructions, process external data, invoke tools, and coordinate with other agents.
...
**来源**：arxiv · AI安全 · **发布日期**：2026-06-18 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.20408v1)

**摘要总结**：Large language model (LLM) agents are increasingly proposed as supervisory components for safety-critical systems, yet their robustness under sustained, adaptive adversarial pressure remains poorly characterized.
...
**来源**：arxiv · AI安全 · **发布日期**：2026-06-18 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.19887v1)

**摘要总结**：Existing safety benchmarks target general adversarial scenarios but miss finance-specific risks.
...
**来源**：arxiv · AI安全 · **发布日期**：2026-06-18 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.19755v1)

**摘要总结**：Speculative inference accelerates large language model (LLM) decoding but provides no inherent safety guarantees.
...
### [A Layered Security Framework Against Prompt Injection in RAG-Based Chatbots](https://arxiv.org/abs/2606.19660v1)

**作者**：Gulshan Saleem, Nisar Ahmed, Muhammad Imran Zaman, Ali Hassan

**来源**：arxiv · AI安全 · **发布日期**：2026-06-17 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.19660v1)

**摘要总结**：Prompt injection is ranked as the most critical vulnerability in large language model (LLM) deployments by the OWASP Top 10 for LLM Applications, yet existing defenses operate at isolated pipeline stages and remain incomplete.
...
### [Analyzing the Narration Gap in LLM-Solver Loops](https://arxiv.org/abs/2606.19588v1)

**作者**：Zunchen Huang, Songgaojun Deng

**来源**：arxiv · AI安全 · **发布日期**：2026-06-17 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.19588v1)

**摘要总结**：Formal tools such as SAT and SMT solvers are increasingly embedded in language model reasoning pipelines when a safety or security critical question can be formulated in logic.
...
**来源**：arxiv · AI安全 · **发布日期**：2026-06-15 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.17034v1)

**摘要总结**：Post-hoc context erasing over the KV cache is challenging because a local edit has a global consequence: once a span has been processed, its influence propagates into the cached states of all subsequent tokens.
...
**来源**：arxiv · AI安全 · **发布日期**：2026-06-15 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.16808v1)

**摘要总结**：While Large Reasoning Models (LRMs) excel at complex tasks, they remain highly vulnerable to sophisticated jailbreaks and direct harmful queries.
...
**来源**：arxiv · AI安全 · **发布日期**：2026-06-15 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.16751v1)

**摘要总结**：Large language models (LLMs) have demonstrated remarkable capabilities across a wide range of tasks.
...
**来源**：arxiv · AI安全 · **发布日期**：2026-06-15 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.16605v1)

**摘要总结**：World models are widely used in robotic and agentic engineering control systems due to their ability to learn latent dynamics for planning and decision-making.
...
**来源**：arxiv · AI安全 · **发布日期**：2026-06-15 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.16527v1)

**摘要总结**：As large language models (LLMs) are increasingly deployed in user-facing systems, black-box jailbreak defense has become an important practical problem.
...
**来源**：arxiv · AI安全 · **发布日期**：2026-06-15 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.16242v1)

**摘要总结**：The Rapid Response (RR) framework, deployed in production systems, including Anthropic's ASL-3 safeguards, continuously improves jailbreak-detection classifiers.
...
**来源**：arxiv · AI安全 · **发布日期**：2026-06-14 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.15899v1)

**摘要总结**：Open-source LLM agent ecosystems are growing rapidly, yet the security of community-contributed skills - modular tool definitions that extend agent capabilities - remains largely unvetted.
...
### [GAS-Leak-LLM: Genetic Algorithm-Based Suffix Optimization for Black-Box LLM Jailbreaking](https://arxiv.org/abs/2606.15788v1)

**作者**：Aman Anifer, Vignesh Kumar Kembu, Vishnu M, Antonino Nocera, Vinod P., Amal Murali PK, Akshay S Rajan

**来源**：arxiv · AI安全 · **发布日期**：2026-06-14 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.15788v1)

**摘要总结**：Large Language Models (LLMs) constitute pivotal components within the AI-dominated information technology ecosystem.
...
### [On the Adversarial Robustness of Multimodal LLM Judges](https://arxiv.org/abs/2606.15608v1)
...
**来源**：arxiv · AI安全 · **发布日期**：2026-06-13 · **推荐**：★★★☆☆ · [PDF](https://arxiv.org/pdf/2606.15441v1)

**摘要总结**：Indirect prompt injection attacks hijack LLM-based agents by embedding malicious instructions in third-party data that the agent retrieves during task execution.
